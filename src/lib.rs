...
#[component]
pub fn DomChildrenCont<V: IntoView+'static,F:Fn(&Element) -> Option<V>+'static+Clone>(orig:OriginalNode,cont:F,#[prop(optional)] on_load:Option<RwSignal<bool>>) -> impl IntoView {
...
#[component]
pub fn DomCont<V:IntoView+'static,F:Fn(&Element) -> Option<V>+'static+Clone>(#[allow(unused_variables)]orig:OriginalNode,#[allow(unused_variables)]cont:F,#[prop(optional)] on_load:Option<RwSignal<bool>>) -> impl IntoView {
...
#[component]
pub fn DomStringCont<V:IntoView+'static,F:Fn(&Element) -> Option<V>+'static+Clone>(html:String,cont:F,#[prop(optional)] on_load:Option<RwSignal<bool>>) -> impl IntoView {
...
#[component]
pub fn DomStringContMath<V:IntoView+'static,F:Fn(&Element) -> Option<V>+'static+Clone>(html:String,cont:F,#[prop(optional)] on_load:Option<RwSignal<bool>>) -> impl IntoView {
